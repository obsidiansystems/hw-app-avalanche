...
Ledger Hardware Wallet Avalanche JavaScript bindings.
...
Here is a sample app for Node:
    ...
    let Avalanche = require("@ledgerhq/hw-app-avalanche").default;
    ...
    const signTransaction = async () => {
      ...
      const result = await avalanche.signTransaction("44'/9000'/0'/1/0", transaction, contexts);
      return result;
    };
    ...
    const getVersion = async () => {
      const transport = await Transport.create();
      const avalanche = new Avalanche(transport);
      const versionInfo = await avalanche.getAppConfiguration();
      return versionInfo;
    };
    ...
    const getAddress = async () => {
      const transport = await Transport.create();
      const avalanche = new Avalanche(transport);
      const result = await avalanche.getWalletPublicKey("44'/9000'/0'/1/0");
      return result;
    };
